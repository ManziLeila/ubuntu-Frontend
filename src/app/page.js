        ...
        <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', paddingTop: 68, overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', zIndex: 10, textAlign: 'center', maxWidth: 760, padding: '0 24px' }}>
            ...
            <div className="hero-cta" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, marginBottom: 40 }}>
              <Link href="/register" className="btn-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, height: 52, padding: '0 32px', borderRadius: 100, background: 'linear-gradient(135deg,#c9a870,#d4af7a)', color: '#07111f', fontWeight: 700, fontSize: 15, textDecoration: 'none', transition: 'opacity .15s', boxShadow: '0 8px 32px rgba(201,168,112,.25)', whiteSpace: 'nowrap' }}>
                Send Money Now <ArrowRight size={17} />
              </Link>
              <Link href="/login" className="btn-outline" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, height: 52, padding: '0 30px', borderRadius: 100, border: '1.5px solid rgba(201,168,112,.35)', color: '#f0e2c4', fontWeight: 600, fontSize: 15, textDecoration: 'none', transition: 'background .15s', whiteSpace: 'nowrap' }}>
                Sign In
              </Link>
            </div>
            ...
            <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'nowrap' }}>
              {[['RWF','AED'],['RWF','GHS'],['RWF','KES'],['RWF','UGX']].map(([f,t]) => (
                <div key={t} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '7px 18px', borderRadius: 100, border: '1px solid rgba(201,168,112,.3)', background: '#0a1628', fontSize: 12, fontWeight: 600, color: '#c9a870', whiteSpace: 'nowrap' }}>
